...
(function ($) { 
   ...
   $.ajaxloadmore = function (el) {
      ...
      alm.el.append('<div class="' + alm.prefix + 'btn-wrap"><button id="load-more" class="' + alm.prefix + 'load-more-btn more'+ alm.button_class +'"><span class="text">' + alm.button_label + '</span></button></div>');
      ...
      alm.AjaxLoadMore.success = function (data) {
         ...
         if (alm.init) {
            alm.button.html('<span class="text">' + alm.button_label + '</span>');
            alm.init = false;
         ...
         if (alm.data.length) {
            ...
            if (alm.transition === 'fade') { // Fade transition
               alm.el.fadeIn(alm.speed, 'alm_easeInOutQuad', function () {
                  ...
                  if(!isMobile) HW1.layout.HardwareItemClass();
   ...
   $.fn.almSetFilters = function(el, data){
      ...
      el.ajaxloadmore(); // re-initiate Ajax Load More
   };
